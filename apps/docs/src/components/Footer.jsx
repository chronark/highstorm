...
function SmallPrint() {
  return (
    <div className="flex flex-col items-center justify-between gap-5 pt-8 border-t border-neutral-900/5 dark:border-white/5 sm:flex-row">
      <p className="text-xs text-neutral-600 dark:text-neutral-400">
        &copy; Copyright {new Date().getFullYear()}. All rights reserved.
      </p>
      <div className="flex gap-4">
        <SocialLink href="https://twitter.com/chronark_" icon={TwitterIcon}>
          Twitter
        </SocialLink>
        <SocialLink href="https://github.com/chronark/highstorm" icon={GitHubIcon}>
          GitHub
        </SocialLink>
      </div>
    </div>
