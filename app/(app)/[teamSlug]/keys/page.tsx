    ...
    <div className="">
      ...
      <ul role="list" className="space-y-4">
        {team.apikeys.map((key) => (
          <li
            key={key.id}
            className="flex items-center justify-between p-4 border border-neutral-200 rounded"
          >
            <div>
              <span className=" bg-neutral-50 border border-neutral-200 rounded font-mono px-2 py-1 text-sm min-w-max">
                api_XXXXXXXXXXXX{key.lastCharacters}
              </span>
              <p className="text-neutral-500 text-xs mt-2 mx-1">
                Created on{" "}
